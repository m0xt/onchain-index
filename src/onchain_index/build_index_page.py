#!/usr/bin/env python3
"""Render docs/index.html for onchain-index's iteration surface.
...
<title>Onchain Index Iteration Surface</title>
<style>{CSS}</style>
</head>
<body>
<main>
  <header>
    <div class="eyebrow">onchain-index / iteration surface</div>
  ...
  <footer>
    Generated by <code>python -m onchain_index.build_index_page</code>. Dashboard remains at <code>outputs/dashboard.html</code>.
  </footer>
</main>
</body>
</html>
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build the onchain-index iteration surface.")
    parser.add_argument(
        "--output-root",
        type=Path,
